...
export default function HeaderColored({ user }: HeaderProps) {
    ...
    <div className={classes.header}>
      <Container className={classes.mainSection}>
        <Group position="apart">
          <Group position="left">
            {" "}
            <Checkbox size={48} strokeWidth={1.5} color={theme.white} />
            Widepoll
          </Group>
          <Burger
            opened={opened}
          ...
          <Menu
            ...
            control={
              ...
              >
                <Group spacing={7}>
                  <UserCircle size={32} strokeWidth={1.5} color={theme.white} />
                  <Text
                    weight={500}
                    size="sm"
